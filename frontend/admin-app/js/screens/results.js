...
export function renderResults(main, ctx) {
  ...
  function render() {
    ...
    box.innerHTML = `${note}<div class="dash-card" style="overflow-x:auto;"><table class="dtable">
      <thead><tr><th>#</th><th>Team</th><th>Status</th><th>Time</th><th>Fouls</th><th>Checkpoints</th><th>J Q K</th><th>Atk / Def / Guide</th><th>Hints</th><th>Finished</th></tr></thead>
      <tbody>${data.coordinator.map((r) => `
        <tr>
          ...
          <td class="mono">${r.photo_hints_used}</td>
