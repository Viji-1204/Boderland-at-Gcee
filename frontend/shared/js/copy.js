...
export const RULES = [
  ...
  { en: 'At the spot but cannot see the sticker? Ask the radar for a <strong>photo of the checkpoint</strong> - twice per game, never on the last three checkpoints.', jp: '現地でQRが見つからない時は写真ヒントを（1ゲーム2回、最後の3か所は不可）。' },
